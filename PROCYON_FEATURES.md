# PROCYON FEATURES & ARCHITECTURAL LOGIC

This is the canonical document for the Procyon L1 Ecosystem. It serves as the primary memory source for Zapia to ensure zero regression in design, logic, and feature implementation.
...
*   **$PRN (Procyon)**: Public Utility. Network fees, NFTs, brand activations. **Official Ticker: PRN.**
...
*   **JELLO Layer Asset**: https://priscion.com/assets/jello.jpg
